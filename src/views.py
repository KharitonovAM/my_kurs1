...
def get_data_from_exel(filename, type_of_operation, start_data, diap_data):
    ...
    logging_get_data_from_exel.info(f'Сформировали список категорий отфильтрованный по убыванию')
    ...
    if type_of_operation == 0:
        ...
        logging_get_data_from_exel.info(f'Сформировали список наличных отфильтрованный по убыванию')
        ...
        if len(return_list) >7:
            ...
            logging_get_data_from_exel.info(f'Получили сумму категорий которые попадуьт в остальное')
