...
def test_get_exchange(mock_get):
    ...
    mock_get.return_value.json.return_value = {"currency_pair": "GBP_EUR", "exchange_rate": 1.911863}
    assert get_exchange('AUD') == {"currency_pair": "GBP_EUR", "exchange_rate": 1.911863}
...
def test_get_stock_prices(mock_get):
    ...
    mock_get.return_value.status_code = 200
    mock_get.return_value.json.return_value = {"ticker": "AAPL", "name": "Apple Inc.", "price": 192.42, "exchange": "NASDAQ","updated": 1706302801,"currency": "USD"}
    assert get_stock_prices('AAPL') == {"ticker": "AAPL", "name": "Apple Inc.", "price": 192.42, "exchange": "NASDAQ","updated": 1706302801,"currency": "USD"}
